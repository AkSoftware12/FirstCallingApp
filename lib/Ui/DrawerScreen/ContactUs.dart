...
import '../Cart/CartProvider/cart_provider.dart'; // Ensure this is included for Provider
  ...
  Widget _buildContactInfo() {
    return Column(
      ...
      children: [
        ...
        _buildAnimatedContactItem(0, Icons.email_outlined, 'Email: support@example.com'),
        _buildAnimatedContactItem(1, Icons.phone_outlined, 'Phone: +91 123-456-7890'),
        _buildAnimatedContactItem(2, Icons.location_on_outlined, 'Address: 123 Main St, City, India'),
      ],
    );
  }
